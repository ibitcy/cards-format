...
export class CardsFormat {
	...
	public luhnCheck(num: number): boolean {
	...
	public cardType(num: number): CardTypes {
		let _ref: Card = null;
	...
	public reFormatCardNumber(e: KeyboardEvent, callback: (value: string) => void): void {
	...
	public formatCardNumber(e: KeyboardEvent, callback: (value: string) => void): void {
	...
	public replaceFullWidthChars(str: string): string {
		if (str == null) {
			str = '';
		}
	...
	public paymentFormatCardNumber(num: any): string {
		let groups, _ref;
		let numStr: string = num.replace(/\D/g, '');
	...
	public restrictNumeric(e: KeyboardEvent): boolean {
	...
	public restrictCardNumber(e: KeyboardEvent): boolean {
	...
	public formatBackCardNumber(e, callback: (value: string) => void) {
	...
	public reFormatExpiry(e, callback: (value: string) => void): void {
	...
	public paymentFormatExpiry(expiry: string): string {
	...
	public cardExpiryVal(value: string): { month: number, year: number } {
